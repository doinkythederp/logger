...
exports.Color = exports.ColorList = void 0;
...
function Color(name, bright = false) {
    return ("\u001B[" + exports.ColorList[name] + (bright ? ";1m" : "m"));
}
exports.Color = Color;
class Logger {
    constructor(options) {
...
function parseInput(input) {
    ...
    input.forEach(message => {
        ...
        output.push(util_1.inspect(message, { colors: true }));
    });
